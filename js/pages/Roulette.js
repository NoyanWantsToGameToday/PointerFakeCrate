...
export default {
            ...
            <div class="sidebar">
                ...
                <form class="options">
                    <div class="check">
                        ...
                        <label for="main">Top 12 levels</label>
                    </div>
                    <div class="check">
                        <input type="checkbox" id="extended" value="Extended List" v-model="useExtendedList">
                        <label for="extended">Levels below top 12</label>
                    </div>
                    ...
                    <template v-if="levels.length > 0">
                        ...
                        <div class="level" v-for="(level, i) in levels.slice(0, progression.length)">
                            ...
                            <div class="meta">
                                ...
                                <h2><a class="director" :href="'https://pointerfakecrate.vercel.app/#/level/' + level.path" target="_blank">{{ level.name }}</a></h2>
                                <div>
                        ...
                        <div class="level" v-if="!hasCompleted">
                            ...
                            <div class="meta">
                                ...
                                <h2><a class="director" :href="'https://pointerfakecrate.vercel.app/#/level/' + currentLevel.path" target="_blank">{{ currentLevel.name }}</a></h2>
                                <div>
                                    <div style="display: inline-block; width: 50%;">
    ...
    methods: {
        ...
        async onStart() {
            ...
            const list = [];
            if (this.useMainList) {
                list.push(...fullListMapped.slice(0, 12));
            }
            if (this.useExtendedList) {
                list.push(...fullListMapped.slice(12));
            }
